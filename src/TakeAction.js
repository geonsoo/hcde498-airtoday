              ...
              <Jumbotron>
                ...
                <div class="card_list flex-row flex-wrap">
                  ...
                  <Card class="card shadow-sm border-light">
                    <div class="row">
                      <div class="col-sm-4">
                        <img class="card-image" src={turnoff} alt="turn off" />
                      </div>
                      <div class="col">
                        <Card.Body>
                  ...
                  <Card class="card shadow-sm border-light">
                    <div class="row">
                      <div class="col-sm-4">
                        <img class="card-image" src={maintain} alt="tool box" />
                      </div>
                      <div class="col">
                        <Card.Body>
                  ...
                  <Card class="card shadow-sm border-light">
                    <div class="row">
                      <div class="col-sm-4">
                        <img class="card-image" src={idling} alt="blue car" />
                      </div>
                      <div class="col">
                        <Card.Body>
                  ...
                  <Card class="card shadow-sm border-light">
                    <div class="row">
                      <div class="col-sm-4">
                        <img class="card-image" src={compost} alt="compost" />
                      </div>
                      <div class="col">
                        <Card.Body>
                  ...
                  <Card class="card shadow-sm border-light">
                    <div class="row">
                      <div class="col-sm-4">
                        <img class="card-image" src={errands} alt="compost" />
                      </div>
                      <div class="col">
                        <Card.Body>
                      ...
                      <div class="col">
                        <Card.Body>
                          ...
                          <div class="card-text-campaign">
                            ...
                            Health Organization (WHO) and the Climate & Clean
                            Air Coalition (CCAC) to mobilize cities and
                            individuals to protect our health and planet from
                      ...
                      <div class="col">
                        <Card.Body>
                          ...
                          <div class="card-text-campaign">
                            ...
                            grassroots environmental campaigning community in
                            the UK. Groups are run by thousands of volunteers.
                            Find out what your nearest group is working on. If
                            there isn't one, consider starting a new one.
                          </div>
                          <Button variant="outline-dark" size="sm">
                            Visit Campaign Website
                          </Button>
                      ...
                      <div class="col">
                        <Card.Body>
                          ...
                          <div class="card-text-campaign">
                            ...
                            threatens our health. Poor environmental conditions
                            aggravate many of these attacks. That is why the
                            Fight for Clean Air campaign is telling the stories
                            of those who are most impacted by weak smog
                            protections.
                          </div>
                          <Button variant="outline-dark" size="sm">
                            Visit Campaign Website
                    ...
                    <div class="row">
                      ...
                      <div class="col">
                        <Card.Body>
                          ...
                          <div class="card-text-campaign">
                            Have you ever wondered how clean the air is in your
                            area? Or how it compares to neighbouring towns and
                            countries? All GLOBE schools are invited to study
                            air quality and share their data with the GLOBE
                            community.
                          </div>
                          <Button variant="outline-dark" size="sm">
                            Visit Campaign Website
                    ...
                    <div class="row">
                      ...
                      <div class="col">
                        <Card.Body>
                          ...
                          <div class="card-text-campaign">
                            Clean Air Day is coordinated by Global Action Plan,
                            on behalf of 200 Supporter organisations, including
                            royal medical colleges, NHS trusts, local
                            authorities, universities and health charities.
                          </div>
                          <Button variant="outline-dark" size="sm">
                            Visit Campaign Website
                          </Button>
