        ...
        <header className="App-header">
          <Navbar bg="dark" variant="dark" fixed="top">
            ...
            <Navbar.Collapse className="justify-content-end nav_text">
              <Nav.Link href="#air_insight" ><b>Air Insight</b></Nav.Link>
              <Nav.Link href="#take_action"><b>Take Action</b></Nav.Link>
        ...
        <body>
          <div className="wrapper scene_one"  >
            <Container className="first main_page">
              <Row>
                <Col>
                  <span class="section_one_text"><b>The air around you is changing. Will you help to stop it?</b>
                  </span>
                </Col>
              </Row>
